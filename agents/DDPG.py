...
from noise.OUNoise import OUNoise as noise
from buffer.ReplayBuffer import RandomReplayBuffer as buffer

class agent_DDPG():
    """Reinforcement Learning agent that learns using DDPG."""
    def __init__(self, task, learning_rate_actor=0.00005,learning_rate_critic=0.0005, gamma=0.99, tau=0.01):
        self.task = task
        ...
        self.batch_size = 64
        self.memory = buffer(self.buffer_size, self.batch_size)
